...
//                     etTemperature1.setText((String.valueOf(Temperature.KtoF(Double.parseDouble(k)))));
//                     etTemperature2.setText((String.valueOf(Temperature.KtoC(Double.parseDouble(k)))));
//                 } catch (NumberFormatException e){
//                     Toast.makeText(getApplicationContext(), "Please enter a number.", Toast.LENGTH_SHORT).show();
//                 }
//             }});
